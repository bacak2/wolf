...
class ModulKategorieWymagan extends ModulBazowy {

	function __construct(&$Baza, $Uzytkownik, $Parametr, $Sciezka) {
            parent::__construct($Baza, $Uzytkownik, $Parametr, $Sciezka);
            $this->ModulyBezMenuBocznego[] = $this->Parametr;
            $this->Tabela = 'category_required';
            $this->PoleID = 'id';
            $this->PoleNazwy = 'category_required_name';
            $this->Nazwa = 'KategorieWymagan';
        ...
        function &GenerujFormularz(&$Wartosci = array(), $Mapuj = false) {
            ...
            $Formularz->DodajPole($this->PoleNazwy, 'tekst', "Nazwa kategorii wymagań*", array('show_label'=>true,'div_class'=>'super-form-span1'));
